...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{data/tableau2_dens_eff_annee.tex}
\normalsize
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{data/tableau3_dens_dist_annee.tex}
\normalsize
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{data/table_biom_dist_annee.tex}
\normalsize
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{croissance.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{croissance2.pdf}
...
\Sexpr{sn(ges[18,"recr_flu_aj_m1"])} en 2013, le suivi des abondances
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{clddensiteannuelle.pdf}
\caption[Tendance des densités modèle]{Classement des densités en fonction des
années, test Post hoc de Tukey sur le modèle $log(dens) \sim a +s +
\epsilon(ss)$, avec $\epsilon(s) \sim N(0,\sigma_s^2)$ a=année, s=stations,
groupes classés au seuil de 0.05, données log transformées.}
...
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{data/table_densite_age_annee.tex}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{residus.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figure9recrutementeuropeen.png}
