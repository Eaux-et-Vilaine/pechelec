...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\small
\input{../../pdata/pechelec/table/2021/tableau2_dens_eff_annee.tex}
\normalsize
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\small
\input{../../pdata/pechelec/table/2021/tableau3_dens_dist_annee.tex}
\normalsize
...
\small
\input{../../pdata/pechelec/table/2021/table_biom_dist_annee.tex}
\normalsize
...
\ref{tablemr}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{../../pdata/pechelec/table/2021/tableaumr1.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{../../pdata/pechelec/table/2021/anova_croissance.tex}
...
\section{Annexes}
\small
\input{../../pdata/pechelec/table/2021/star.tex}
\normalsize
%\begin{figure}[htbp]
%\centering
...
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{../../pdata/pechelec/table/2021/table_densite_age_annee.tex}
